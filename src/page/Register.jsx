       ...
       <div className='col-12'>
        ...
        <form className="register-form1" onSubmit={formik.handleSubmit}>
            ...
            <div className="register-avatar-container">
              <img src="/avatar.png" alt="avatar" className='formimg' ref={imageRef} />
              <label htmlFor="avatar" className='formim'>
                <span>
          ...
          <input onChange={imageHandler} type="file" name="avatar" id="avatar" accept="image/*" className='register-un' /><br />
